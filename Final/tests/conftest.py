...
───────────────────────
Shared fixtures and mocks for the GEO multi-agent test suite (Final/).
Adapted from Project 2's tests/conftest.py — same fixtures, Final/ import paths.
"""
...
def sample_prompt_df():
    ...
    return pd.DataFrame([
        ...
        {"prompt_id": "p3", "intent_id": "i2", "language": "fr",
         "prompt_text": "Les restaurants tunisiens les plus visites."},
        {"prompt_id": "p4", "intent_id": "i2", "language": "fr",
         "prompt_text": "Ou manger tunisien a Tunis?"},
    ])
