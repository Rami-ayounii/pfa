...
from core.llm_client import MODEL_COMPOUND
...
def agent0_node(state: GEOState) -> dict:
    ...
    analyst_model  = state.get("analyst_model", MODEL_COMPOUND)
    ...
    # Agent0.run() already writes the CSV — no backup needed here
