...
────────────────────
Unit tests for agents/agent1_geo_analyser.py

Focus: step functions, GEO feature calculations, entity deduplication.
...
def test_geo_features_stability_score(clean_entities_df, sample_raw_responses, sample_prompt_df, tmp_path):
    ...
    # stability_score = mention_rate × 1/(1 + rank_variance) — must be ≤ mention_rate
